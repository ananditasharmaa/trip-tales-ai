...
function CreateTrip() {
  ...
  const OnGenerateTrip = async () => {
    ...
    try {
      const result = await chatSession.sendMessage(FINAL_PROMPT); // Get the response from AI
      const responseText = await result?.response?.text(); // Make sure the response is valid
      console.log(responseText);
      
      // After getting the response, save it to Firestore
  ...
  return (
    <div className='sm:px-10 md:px-32 lg:px-56 xl:px-10 px-5 mt-10'>
      ...
      <p className='mt-3 text-gray-500 text-xl'>Simply provide basic information, and our trip planner will generate a customised itinerary based on your preferences</p>
